    ...
    return (
        ...
        >
            <motion.div className="max-w-md mx-auto" variants={staggerItem}>
                ...
                <div className="w-20 h-20 rounded-full bg-white/25 flex items-center justify-center mx-auto mb-6 border-2 border-white/40 shadow-[0_0_20px_rgba(255,255,255,0.2)]">
                ...
                <motion.div className="frozen-card-light bg-white/80 rounded-3xl p-6 text-center border border-white/60" whileHover={{ y: -2, boxShadow: "0 12px 40px rgba(30,144,255,0.15)" }}>
                    ...
                    <div className="border-t border-[#91AEC4]/30 pt-4 mt-4">
    ...
    return (
        ...
        >
            <motion.div className="max-w-md mx-auto text-center" variants={staggerItem}>
                ...
                <h3 className="text-2xl text-white mb-4 frozen-title">DRESS CODE</h3>
                <p className="text-5xl text-white frozen-name mb-4">{CONFIG.dressCode}</p>
                <div className="flex justify-center">
                    <div className="inline-flex items-center justify-center gap-2 bg-white/20 rounded-full px-6 py-3 border border-white/30">
                        <span className="text-white text-sm font-medium">{CONFIG.dressCodeNota}</span>
                    </div>
                </div>
            </motion.div>
        </motion.section>
    ...
    return (
        ...
        >
            <motion.div className="max-w-md mx-auto" variants={staggerItem}>
                ...
                <div className="w-16 h-16 rounded-full bg-[#1e90ff]/20 flex items-center justify-center mx-auto mb-4 border-2 border-[#5F84A2]/40 shadow-[0_0_15px_rgba(30,144,255,0.15)]">
                    <Church className="w-8 h-8 text-[#194569]" />
                </div>
                <h3 className="text-center text-xl text-[#194569] mb-4 frozen-title">CEREMONIA RELIGIOSA</h3>
        ...
        >
            <motion.div className="max-w-lg mx-auto grid grid-cols-2 gap-5" variants={staggerContainer}>
                {CONFIG.fotos.slice(0, 2).map((foto, i) => (
                    ...
                    >
                        <Image src={foto} alt={`Foto ${i + 1}`} fill sizes="(max-width: 768px) 50vw, 400px" className="object-cover" />
    ...
    return (
        ...
        >
            <motion.div className="max-w-md mx-auto text-center" variants={staggerItem}>
                ...
                <p className="text-[#E0F4FF] text-lg mb-4 frozen-name-night">¡Quiero ver tus fotos!</p>
...
function Section8Regalo() {
    ...
    return (
        ...
        >
            <motion.div className="max-w-md mx-auto" variants={staggerItem}>
                <div className="frozen-divider frozen-divider-light"><SnowflakeIcon className="w-4 h-4 text-[#194569]/60" /></div>
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-yellow-300/30 to-yellow-500/30 flex items-center justify-center mx-auto mb-6 border-2 border-yellow-400/40 shadow-[0_0_20px_rgba(234,179,8,0.2)]">
                ...
                <div className="frozen-card-light bg-white/40 backdrop-blur-md rounded-3xl p-6 text-center border border-white/50 shadow-[0_8px_32px_rgba(25,69,105,0.12)]">
                    ...
                    {!show ? (
                        ...
                        <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-4 flex items-center justify-between gap-4 border border-white/40">
                            ...
                            <button onClick={copy} className={clsx("w-12 h-12 rounded-full flex items-center justify-center text-white", copied ? "bg-green-500" : "bg-[#1e90ff]")}>
        ...
        >
            <motion.div className="max-w-lg mx-auto" variants={staggerItem}>
                <div className="grid grid-cols-2 gap-5 mb-12">
                    {CONFIG.fotos.slice(2, 4).map((foto, i) => (
                        <motion.div
                            ...
                            whileHover={{ scale: 1.03, boxShadow: "0 24px 48px rgba(30,144,255,0.25)" }}
                        >
                            <Image src={foto} alt={`Foto ${i + 3}`} fill sizes="(max-width: 768px) 50vw, 400px" className="object-cover" />
                ...
                <motion.div className="text-center" variants={staggerItem}>
                    ...
                    <p className="text-[#194569] text-xl frozen-name-night">Preparate para una noche</p>
                ...
                {!done ? (
                    <div className="frozen-card-light bg-white/85 rounded-3xl p-6 border border-white/80">
                        <div className="flex justify-center gap-2 mb-6">
                            {CONFIG.quiz.map((_, i) => (<div key={i} className={clsx("w-3 h-3 rounded-full", i < answers.length && "bg-[#1e90ff]", i === curr && "bg-[#1e90ff]/50 scale-125", i > curr && "bg-gray-300")} />))}
                        </div>
                            ...
                            {q.opciones.map((op, i) => {
                                ...
                                return (
                                    <motion.button key={i} onClick={() => !answered && answer(i)} disabled={answered}
                                        className={clsx("w-full p-4 rounded-2xl text-left border-2", showG && "bg-green-100 border-green-400 text-green-700", showR && "bg-red-100 border-red-400 text-red-700", !showG && !showR && "bg-white/50 border-gray-200 text-[#194569] hover:border-[#1e90ff]")}
                                        whileHover={!answered ? { scale: 1.02 } : {}}
                                        whileTap={!answered ? { scale: 0.98 } : {}}
                                    >
                                        <span className="flex items-center gap-3">
                                            <span className={clsx("w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold", showG && "bg-green-400 text-white", showR && "bg-red-400 text-white", !showG && !showR && "bg-gray-200")}>{String.fromCharCode(65 + i)}</span>
                                            {op}
                                        </span>
                                    </motion.button>
                                );
