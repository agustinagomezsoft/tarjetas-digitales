    ...
    return new ImageResponse(
        (
            ...
            >
                ...
                <div style={{ position: "absolute", top: "40px", left: "80px", width: "8px", height: "8px", borderRadius: "50%", background: "#FFD700" }} />
                <div style={{ position: "absolute", top: "120px", right: "150px", width: "6px", height: "6px", borderRadius: "50%", background: "#87CEEB" }} />
                <div style={{ position: "absolute", bottom: "100px", left: "200px", width: "5px", height: "5px", borderRadius: "50%", background: "#fff" }} />
                <div style={{ position: "absolute", top: "200px", left: "100px", width: "4px", height: "4px", borderRadius: "50%", background: "#87CEEB" }} />
                <div style={{ position: "absolute", bottom: "150px", right: "100px", width: "6px", height: "6px", borderRadius: "50%", background: "#FFD700" }} />
                <div style={{ position: "absolute", top: "80px", right: "80px", width: "5px", height: "5px", borderRadius: "50%", background: "#fff" }} />
                <div style={{ position: "absolute", bottom: "200px", left: "120px", width: "4px", height: "4px", borderRadius: "50%", background: "#FFD700" }} />
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
                    ...
                    <span style={{ color: "#87CEEB", fontSize: "16px", letterSpacing: "0.3em", textTransform: "uppercase" }}>
                        Estás invitado a
                    </span>
                    <span style={{ color: "#87CEEB", fontSize: "18px" }}>❄</span>
                </div>
                ...
                {/* MIS XV */}
                <div style={{ display: "flex", fontSize: "72px", fontWeight: "300", letterSpacing: "0.15em", marginBottom: "8px" }}>
                    <span style={{ color: "#fff" }}>MIS</span>
                    <span style={{ color: "#87CEEB" }}>XV</span>
                </div>

                {/* Nazarena */}
                <div style={{ fontSize: "64px", fontStyle: "italic", color: "#E0F4FF", marginBottom: "24px" }}>
                    Nazarena
                </div>
                ...
                >
                    <span style={{ color: "#87CEEB", fontSize: "20px" }}>📅</span>
